defmodule EventasaurusApp.Repo.Migrations.AddPerformersAndObanIndexes do
  ...
  def up do
    ...
    execute """
    CREATE INDEX CONCURRENTLY IF NOT EXISTS performers_source_id_index
    ...
    execute """
    CREATE INDEX CONCURRENTLY IF NOT EXISTS performers_lower_name_index
    ...
    execute """
    CREATE INDEX CONCURRENTLY IF NOT EXISTS oban_jobs_queue_index
    ON oban_jobs(queue)
    """
  end
