defmodule EventasaurusApp.Repo.Migrations.ConvertTriviaEventsExportToMaterializedView do
  use Ecto.Migration
  ...
  def up do
    ...
    # Step 3: Create UNIQUE index on id (required for REFRESH CONCURRENTLY)
    execute """
  ...
  def down do
    ...
    # Recreate the original regular VIEW
    execute """
