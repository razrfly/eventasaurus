...
CREATE TABLE public.events (
    ...
    state character varying(255) DEFAULT 'confirmed'::character varying NOT NULL,
...
--
-- Name: event_participants_event_id_user_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX event_participants_event_id_user_id_index ON public.event_participants USING btree (event_id, user_id);


--
-- Name: event_participants_user_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: event_users_event_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX event_users_event_id_index ON public.event_users USING btree (event_id);


--
-- Name: event_users_event_id_user_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX event_users_event_id_user_id_index ON public.event_users USING btree (event_id, user_id);


--
-- Name: event_users_user_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX event_users_user_id_index ON public.event_users USING btree (user_id);
...
--
-- Name: events_state_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX events_state_index ON public.events USING btree (state);


--
-- Name: events_theme_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX events_theme_index ON public.events USING btree (theme);
...
--
-- Name: users_supabase_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX users_supabase_id_index ON public.users USING btree (supabase_id);
...
CREATE POLICY "Enable insert for authenticated users only" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'event-images'::text));


--
-- Name: objects Enable read access for all users; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Enable read access for all users" ON storage.objects FOR SELECT USING ((bucket_id = 'event-images'::text));
...
INSERT INTO public."schema_migrations" (version) VALUES (20240512000001);
INSERT INTO public."schema_migrations" (version) VALUES (20240512000002);
INSERT INTO public."schema_migrations" (version) VALUES (20240512000003);
INSERT INTO public."schema_migrations" (version) VALUES (20240512000004);
INSERT INTO public."schema_migrations" (version) VALUES (20250508104758);
