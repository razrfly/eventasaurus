defmodule EventasaurusApp.Events.SoftDeleteQueryTest do
  ...
  describe "soft delete filtering in queries" do
    ...
    test "list_events includes soft-deleted events with option", %{
      active_event: active,
    ...
    test "list_events_by_user excludes soft-deleted events by default", %{
      user: user,
      active_event: active
    } do
    ...
    test "list_events_by_user includes soft-deleted events with option", %{
      user: user,
      active_event: active,
      deleted_event: deleted
    } do
  ...
  describe "soft delete filtering in participant queries" do
    ...
    test "list_events_with_participation excludes soft-deleted events", %{
      participant: participant,
      active_event: active
    } do
    ...
    test "list_events_with_participation includes soft-deleted with option", %{
      participant: participant,
      active_event: active,
      deleted_event: deleted
    } do
    ...
    test "list_organizer_events_with_participants excludes soft-deleted", %{
      organizer: organizer,
      active_event: active
    } do
    ...
    test "get_historical_participants excludes participants from soft-deleted events", %{
      organizer: organizer,
      participant: participant
    } do
  ...
  describe "soft delete filtering in poll queries" do
    ...
    test "get_event_poll excludes polls from soft-deleted events", %{
      active_event: active,
      deleted_event: deleted
    } do
    ...
    test "get_event_poll includes polls from soft-deleted events with option", %{
      deleted_event: deleted
    } do
  ...
  describe "soft delete filtering with complex queries" do
    ...
    test "list_ended_events includes soft-deleted with option", %{
      past_event: past,
