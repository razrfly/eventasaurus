defmodule EventasaurusApp.Scraping.Processors.EventProcessor do
  @moduledoc """
  ...
  alias EventasaurusApp.PublicEvents.{PublicEvent, PublicEventSource, PublicEventPerformer}
  alias EventasaurusApp.Performers.Performer
  alias EventasaurusApp.Scraping.Processors.VenueProcessor
  alias EventasaurusApp.Scraping.Helpers.Normalizer
