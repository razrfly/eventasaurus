defmodule EventasaurusApp.Scraping.Helpers.Normalizer do
  @moduledoc """
  ...
  def normalize_phone(phone) when is_binary(phone) do
    ...
    case String.length(digits) do
      10 -> format_us_phone(digits)
      11 when String.starts_with?(digits, "1") -> format_us_phone(String.slice(digits, 1..-1))
      _ -> phone
    end
  end
