defmodule EventasaurusApp.PublicEvents.PublicEventPerformer do
  use Ecto.Schema
  ...
  schema "public_event_performers" do
    ...
    belongs_to :event, EventasaurusApp.PublicEvents.PublicEvent
    belongs_to :performer, EventasaurusApp.Performers.Performer
