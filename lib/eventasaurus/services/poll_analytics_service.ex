defmodule Eventasaurus.Services.PollAnalyticsService do
  ...
  # Poll voting events
  @spec track_poll_vote(String.t(), String.t(), String.t(), String.t(), map()) ::
          {:ok, :sent} | {:error, any()}
  def track_poll_vote(user_id, poll_id, option_id, voting_system, metadata \\ %{}) do
    ...
    unless user_id && user_id != "" do
      raise ArgumentError,
            "user_id is required - use AnonymousIdService.get_user_identifier/2 for anonymous users"
    end
  ...
  @spec track_poll_suggestion_created(String.t(), String.t(), String.t(), map()) ::
          {:ok, :sent} | {:error, any()}
  ...
  @spec track_poll_suggestion_approved(String.t(), String.t(), String.t(), map()) ::
          {:ok, :sent} | {:error, any()}
  ...
  @spec track_poll_phase_changed(String.t(), String.t(), String.t(), String.t(), map()) ::
          {:ok, :sent} | {:error, any()}
  ...
  @spec track_poll_guest_invited(String.t(), String.t(), String.t(), map()) ::
          {:ok, :sent} | {:error, any()}
