defmodule EventasaurusWeb.Admin.Components.DashboardComponents do
  ...
  @doc """
  Renders an icon based on the name attribute.
  Uses inline SVG paths for common icons, falls back to info icon.

  ## Supported icons
  - "hero-chart-bar" - Bar chart icon
  - "hero-exclamation-triangle" - Warning/alert icon
  - "hero-check-circle" - Success/check icon
  - "hero-clock" - Time/clock icon
  - "hero-cog" - Settings icon
