defmodule EventasaurusWeb.EventLive.New do
        ...
        form_data when is_map(form_data) ->
          ...
          if !is_virtual and venue_name && venue_name != "" do
            ...
            venue_attrs = %{
              ...
              "source" => "google"  # Mark venues from Google Places as source: google
            }
  ...
  def handle_event("location_cleared", %{"mode" => _mode}, socket) do
    ...
    form_data = Map.drop(socket.assigns.form_data || %{}, [
      "venue_name",
      "venue_address",
      "venue_city",
      "venue_state",
  ...
  def handle_event("place_selected", %{"details" => place_details}, socket) do
    ...
    form_data = %{
      ...
      "venue_place_id" => Map.get(place_details, "place_id")  # Store Google Places ID
    }
