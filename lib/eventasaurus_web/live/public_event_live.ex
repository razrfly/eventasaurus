defmodule EventasaurusWeb.PublicEventLive do
  ...
  def render(assigns) do
    ~H"""
    <!-- Public Event Show Page with clean, minimal design -->
      ...
      <div class="public-event-layout">
        <div class="event-details-section">
          ...
          <%= if @event.description && @event.description != "" do %>
            <div class="bg-white p-6 rounded-xl mb-8 shadow-sm border border-gray-100">
        ...
        <div class="sidebar-section">
          <div class="registration-section">
            ...
            <button
              ...
              class="registration-button block text-center w-full"
            >
              Register Now
          ...
          <!-- Share buttons -->
          <div class="bg-white rounded-xl p-5 mb-4 border border-gray-100 shadow-sm">
            <h3 class="text-base font-semibold mb-3">Share this event</h3>
            <div class="flex space-x-3">
              <a href={"https://twitter.com/intent/tweet?text=Check out #{@event.title}&url=#{URI.encode_www_form(EventasaurusWeb.Endpoint.url() <> "/#{@event.slug}")}"} target="_blank" class="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
              ...
              <a href={"https://www.facebook.com/sharer/sharer.php?u=#{URI.encode_www_form(EventasaurusWeb.Endpoint.url() <> "/#{@event.slug}")}"} target="_blank" class="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
              ...
              <a href={"https://www.linkedin.com/sharing/share-offsite/?url=#{URI.encode_www_form(EventasaurusWeb.Endpoint.url() <> "/#{@event.slug}")}"} target="_blank" class="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
              ...
              <button id="copy-link-btn" class="bg-gray-100 hover:bg-gray-200 p-2 rounded-full" data-clipboard-text={EventasaurusWeb.Endpoint.url() <> "/#{@event.slug}"}>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
