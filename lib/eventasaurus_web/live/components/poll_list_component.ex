defmodule EventasaurusWeb.PollListComponent do
                    ...
                    <div class="flex-1">
                      ...
                      <div class="mt-2 flex items-center space-x-4 text-sm text-gray-500">
                        ...
                        <span class="inline-flex items-center">
                          ...
                          <%= poll.vote_count || 0 %> <%= ngettext("vote", "votes", poll.vote_count || 0) %>
                        </span>
                      </div>
                    </div>
  ...
  defp assign_computed_properties(socket) do
    %{user: user, event: event} = socket.assigns

    can_create_polls = user != nil && Events.can_create_poll?(user, event)
