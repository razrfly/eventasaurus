defmodule EventasaurusWeb.Router do
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/dev/marketing", EventasaurusWeb do
      ...
      get "/manifesto", MarketingController, :manifesto
      get "/problem", MarketingController, :problem
      get "/home-v2", MarketingController, :homepage_v2
      get "/why-v2", MarketingController, :why_wombie_v2
    end
    ...
    live_session :admin_dev,
      ...
      scope "/admin", EventasaurusWeb do
        ...
        live "/venues/exclusions", Admin.VenueExclusionsLive
  ...
  if Mix.env() == :prod do
    ...
    live_session :admin_authenticated,
      ...
      scope "/admin" do
        ...
        live "/venues/exclusions", EventasaurusWeb.Admin.VenueExclusionsLive
