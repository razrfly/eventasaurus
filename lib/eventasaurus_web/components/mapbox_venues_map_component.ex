defmodule EventasaurusWeb.MapboxVenuesMapComponent do
  @moduledoc """
  Interactive map component for displaying multiple venues with markers.
  Uses Mapbox GL JS for interactive features like clustering and popups.
  """
  use EventasaurusWeb, :live_component

  @doc """
  Renders an interactive Mapbox map showing all venues in a city.
