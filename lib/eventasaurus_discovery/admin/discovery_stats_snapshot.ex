defmodule EventasaurusDiscovery.Admin.DiscoveryStatsSnapshot do
  @moduledoc """
  Schema for storing pre-computed discovery stats snapshots.

  Stats are computed by an Oban job running every 15 minutes and stored in this table.
  The admin stats page reads from the latest snapshot instead of computing stats on-demand.
  ...
  Default keeps last 10 snapshots.
  """
  def cleanup(keep_count \\ 10) do
