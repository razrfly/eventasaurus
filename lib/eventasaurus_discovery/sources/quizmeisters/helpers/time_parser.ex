defmodule EventasaurusDiscovery.Sources.Quizmeisters.Helpers.TimeParser do
  @moduledoc """
  Parses Quizmeisters time text into structured day/time data.

  Quizmeisters provides schedule information in formats like:
  - "Wednesdays at 7pm"
  ...
  ## Examples
      iex> parse_time_text("Wednesdays at 7pm")
      {:ok, {:wednesday, ~T[19:00:00]}}

      iex> parse_time_text("Thursdays at 8:00 PM")
      {:ok, {:thursday, ~T[20:00:00]}}

      iex> parse_time_text("Tuesdays at 7:30pm")
      {:ok, {:tuesday, ~T[19:30:00]}}
  ...
  ## Examples
      iex> next_occurrence(:wednesday, ~T[19:00:00])
      ~U[2025-10-15 23:00:00Z]  # Next Wednesday at 7pm ET converted to UTC
  """
