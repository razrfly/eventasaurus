defmodule Mix.Tasks.TestCollision do
  ...
  def run(_args) do
    ...
    scenario_1_event_id =
      case EventProcessor.process_event(test_event, tm_source.id, tm_source.priority) do
        {:ok, event} ->
    ...
    _scenario_2_event_id =
      case EventProcessor.process_event(bit_event, bit_source.id, bit_source.priority) do
        {:ok, event} ->
