defmodule Mix.Tasks.Venues.CleanGwdNames do
  ...
  - "Wild Corgi Pub (check venue for reservations!)" → "Wild Corgi Pub"
  - "Pandora's Box @Alamo Drafthouse Westminster (Monday)" → "Pandora's Box"
  ...
  def run(args) do
    ...
    Logger.info("""
    🧹 Cleaning Geeks Who Drink venue names...
        ...
        if needs_cleaning do
          ...
          if dry_run do
            ...
            case update_venue_name(venue, clean_name) do
              {:ok, updated_venue} ->
                Logger.info("  ✅ Updated slug: #{updated_venue.slug}\n")
